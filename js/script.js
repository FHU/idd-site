$(document).ready(function () {
    ...
    $('header .container #img-text h4').fitText(1, {
        maxFontSize: '15px'
    });
...
function fix_svg_height() {
    if (typeof InstallTrigger !== 'undefined') {
        $("#core-classes .svg-container:nth-child(1)").css({
            "height": $("#core-classes .classes-container:nth-child(2)").height() - 1
        });
        $("#core-classes .svg-container:nth-child(3)").css({
            "height": $("#core-classes .classes-container:nth-child(4)").height() - 1
        });
        $("#core-classes .svg-container:nth-child(5)").css({
            "height": $("#core-classes .classes-container:nth-child(6)").height() - 1
        });
        $("#dev-track .svg-container:nth-child(1)").css({
            "height": $("#dev-track .classes-container:nth-child(2)").height() - 1
        });
        $("#dev-track .svg-container:nth-child(3)").css({
            "height": $("#dev-track .classes-container:nth-child(4)").height() - 1
        });
        $("#design-track .svg-container:nth-child(1)").css({
            "height": $("#design-track .classes-container:nth-child(2)").height() - 1
        });

        if ($(window).width() >= 992) {
            $("#design-track .classes-container:nth-child(4)").css({
                "height": $("#dev-track").height() - $("#design-track .classes-container:nth-child(2)").height() - 1
            })
        }
        $("#design-track .svg-container:nth-child(3)").css({
            "height": $("#design-track .classes-container:nth-child(4)").height() - 1
        });
    } else {
        $("#core-classes .svg-container:nth-child(1)").css({
            "height": $("#core-classes .classes-container:nth-child(2)").height()
        });
        $("#core-classes .svg-container:nth-child(3)").css({
            "height": $("#core-classes .classes-container:nth-child(4)").height()
        });
        $("#core-classes .svg-container:nth-child(5)").css({
            "height": $("#core-classes .classes-container:nth-child(6)").height()
        });
        $("#dev-track .svg-container:nth-child(1)").css({
            "height": $("#dev-track .classes-container:nth-child(2)").height()
        });
        $("#dev-track .svg-container:nth-child(3)").css({
            "height": $("#dev-track .classes-container:nth-child(4)").height()
        });
        $("#design-track .svg-container:nth-child(1)").css({
            "height": $("#design-track .classes-container:nth-child(2)").height()
        });

        if ($(window).width() >= 992) {
            $("#design-track .classes-container:nth-child(4)").css({
                "height": $("#dev-track").height() - $("#design-track .classes-container:nth-child(2)").height()
            })
        }
        $("#design-track .svg-container:nth-child(3)").css({
            "height": $("#design-track .classes-container:nth-child(4)").height()
        });
    }
}
...
//core points
var core1_head = core1.circle(26, 33, 7).attr({
    fill: "#67c4ef"
});
...
//dev points
var dev_head = dev1.circle(26, 33, 7).attr({
    fill: "#67c4ef"
});
...
//design points
var design_head = design1.circle(26, 33, 7).attr({
    fill: "#67c4ef"
});
